...
namespace Projecrt.V11
{
    public partial class FormSerch : Form
    {
        ...
        private void dataGridView_Result_BMS_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        /*private void button_SortColumnsAlphabetically_BMS_Click(object sender, EventArgs e)
        {
            if (dataGridView_Result_BMS.DataSource != null)
            {
                DataTable dataTable = (DataTable)dataGridView_Result_BMS.DataSource;

                foreach (DataColumn column in dataTable.Columns)
                {
                    SortColumnAlphabetically(dataTable, column.ColumnName);
                }
            }
        }*/

        private void SortColumnAlphabetically(DataTable dataTable, string columnName)
        {
        ...
        private void textBox_Find_BMS_TextChanged(object sender, EventArgs e)
        {
